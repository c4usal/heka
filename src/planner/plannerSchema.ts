...
export const plannerJsonSchema = {
  ...
  schema: {
    ...
    required: ["objective", "location", "geographicScope", "requiredDatasets", "constraints", "assumptions", "answer", "desiredOutput", "workflowSummary", "workflow", "confidence", "clarificationQuestions", "executionReadiness"],
    properties: {
      ...
      answer: { type: "string", description: "Short user-facing recommendation or finding. No workflow jargon." },
      desiredOutput: { type: "string" }, workflowSummary: { type: "string" },
