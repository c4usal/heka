...
#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
struct ExecutionRequest { data_directory: Option<String>, output_path: Option<String> }
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![runtime_health, execute_fire_station_analysis])
